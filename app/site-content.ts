...
export const defaultSiteContent: SiteContent = {
  hero: {
    kicker: "בייקרי, בית קפה, מגשי אירוח, B2B",
    cta: "LET'S TALK",
  },
  cafe: {
    headline1: "מחבוא קטן.",
  ...
  business: {
    ...
    lead2: "מוכן אצלכם.",
    body:
      "מאפים, לחמים, עוגות ועוגיות בעבודת יד. נאפים מוקדם, מגיעים בזמן ומוכנים להצבה אצלכם בבית העסק — גם בשישי ובשבת. הצטרפו לטובים ביותר שכבר מגישים את המוצר הטוב בעיר.",
