  ...
  return (
    <main>
      ...
      <section className="chapter" id="cafe">
        ...
        <div className="chapter-copy marble">
          ...
          <div className="chapter-details">
            <p><span className="detail-label">{t.detailAddress}</span><span className="detail-value" dir="rtl">{content.cafe.address}</span></p>
            <p><span className="detail-label">{t.detailHours}</span><span className="detail-value" dir="rtl">{content.cafe.hours}</span></p>
          </div>
      ...
      <section className="careers" id="careers">
        ...
        <p className="careers-subtitle">{t.careersSubtitle}</p>
      ...
      <section className="social-links" aria-label={t.socialAria}>
        <a href={instagramHref} target="_blank" rel="noreferrer" aria-label={t.socialInstagram}>
          <InstagramIcon />
        </a>
        <a href={tiktokHref} target="_blank" rel="noreferrer" aria-label={t.socialTikTok}>
          <TikTokIcon />
        </a>
